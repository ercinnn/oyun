...
const archimedesScientist = Scientist(
  id: 'arsimet',
  name: 'Arşimet',
...
const galileoScientist = Scientist(
  id: 'galileo',
...
const newtonScientist = Scientist(
  id: 'newton',
  name: 'Isaac Newton',
...
const teslaScientist = Scientist(
  id: 'tesla',
  name: 'Nikola Tesla',
...
const curieScientist = Scientist(
  id: 'curie',
  name: 'Marie Curie',
...
const einsteinScientist = Scientist(
  id: 'einstein',
...
const flemingScientist = Scientist(
  id: 'fleming',
