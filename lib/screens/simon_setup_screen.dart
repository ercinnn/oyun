...
class _SimonSetupScreenState extends State<SimonSetupScreen> {
  ...
  void _startGame() {
    ...
    context.read<SimonController>().startGame([
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Simon Diyor ki')),
      body: Center(
          ...
          child: SingleChildScrollView(
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    'Sadece "Simon dedi ki" ile başlayan talimatı uygula, '
                    'değilse Pas Geç\'e bas! $simonRoundsPerPlayer turda en '
                    'çok doğruyu bilen kazanır.',
