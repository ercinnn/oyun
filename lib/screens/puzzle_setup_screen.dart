...
class PuzzleSetupScreen extends StatefulWidget {
  const PuzzleSetupScreen({super.key});
...
class _PuzzleSetupScreenState extends State<PuzzleSetupScreen> {
  ...
  void _startGame() {
    ...
    context.read<PuzzleController>().startGame([
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Kayan Yapboz')),
      body: Center(
          ...
          child: SingleChildScrollView(
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  const Text(
                    'Sayıları sırayla dizmeye çalış! Boş kareye komşu bir '
                    'sayıya dokunarak kaydır. En az hamlede tamamlayan '
                    'kazanır.',
