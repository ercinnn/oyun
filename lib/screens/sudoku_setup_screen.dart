...
import '../widgets/sudoku_difficulty_selector.dart';
...
class _SudokuSetupScreenState extends State<SudokuSetupScreen> {
  ...
  int _playerCount = 2;
  SudokuDifficulty _difficulty = SudokuDifficulty.orta;
  ...
  void _startGame() {
    ...
    context.read<SudokuController>().startGame([
          ...
          child: SingleChildScrollView(
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    '9×9 ızgarayı 1-9 ile doldur! Her satır, sütun ve 3×3 '
                    'kutuda her rakam yalnızca bir kez bulunsun. '
                    '$sudokuMaxMistakes hakkın var, dikkatli ol!',
                  ...
                  Center(
                    child: SudokuDifficultySelector(
                      difficulty: _difficulty,
                      onChanged: (value) =>
