...
class ReflexSetupScreen extends StatefulWidget {
  const ReflexSetupScreen({super.key});

  @override
  State<ReflexSetupScreen> createState() => _ReflexSetupScreenState();
}

class _ReflexSetupScreenState extends State<ReflexSetupScreen> {
  ...
  void _startGame() {
    ...
    context.read<ReflexController>().startGame([
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Tepki Süresi')),
      body: Center(
          ...
          child: SingleChildScrollView(
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    'Ekran yeşile dönünce olabildiğince hızlı dokun! Erken '
                    'dokunursan ceza alırsın. $reflexRoundsPerPlayer turda '
                    'en düşük ortalama süreye sahip olan kazanır.',
